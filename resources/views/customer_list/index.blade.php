<x-app-layout>
    <div class="py-5 mx-5">
        <div class="grid grid-cols-12 gap-4">
            ...
            <a href="" class="col-start-10 xl:col-start-12 col-span-3 xl:col-span-1 bg-black text-white rounded-lg text-center text-base xl:text-2xl py-3">追加</a>
        </div>
        <!-- 抽出条件 -->
        ...
        <div class="grid grid-cols-12 gap-4 mt-5">
            @foreach($customers as $customer)
                <a href="" class="col-span-12 xl:col-span-4 grid grid-cols-12">
                    ...
                    <p class="col-span-5 bg-gray-300 text-center py-3 border-b-2">拠点名</p>
