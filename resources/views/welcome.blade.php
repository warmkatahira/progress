    ...
    <body style="font-family:Kosugi Maru" class="bg-gray-100">
        <div class="min-h-screen px-5">
            <div class="grid grid-cols-12">
                <p class="col-span-12 text-4xl text-blue-500">Progress-業務進捗掲示板-</p>
            </div>
            @if (Route::has('login'))
                <div class="grid grid-cols-12 mt-20">
                    @auth
                        <a href="{{ route('post_list.index') }}" class="col-start-4 col-span-6 text-6xl text-center bg-gray-300 h-60 py-20 rounded-lg">ホーム</a>
                    @else
